                ...
                const remoteResult = await claudeRemote({
                    ...
                    nextMessage: async () => {
                        ...
                        if (msg) {
                            ...
                            // Each one was proven sendable at the download checkpoint, so
                            // there is nothing left to check or skip here.
                            ...
                            const contentBlocks: ContentBlockParam[] = [
                                ...toClaudeImageBlocks(attachments),
                                { type: 'text' as const, text: msg.message },
                            ];
                            logger.debug(`[remote] Combined ${attachments.length} image(s) with text message`);
                            return {
