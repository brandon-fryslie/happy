...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        tts: 'Sessões faladas',
        ttsSubtitle: 'Resuma e leia em voz alta as mensagens do agente',
    ...
    newSession: {
        ...
        addProjectDirectory: 'Adicionar como diretório de projetos',
        removeProjectDirectory: 'Remover diretório de projetos',
        noProjectDirectories: 'Adicione um diretório raiz com +',
        emptyProjectDirectory: 'Nenhum subdiretório encontrado',
    },
    ...
    settingsTts: {
        ...
        enabledTitle: 'Sessões faladas',
        enabledFooter: 'Resuma as mensagens do agente com seu próprio LLM e leia-as em voz alta com o ElevenLabs. Tudo permanece no seu dispositivo — chaves e texto das mensagens nunca chegam aos servidores do Happy.',
        enableLabel: 'Ativar',
        enableSubtitleOn: 'Barra de controle de voz exibida nas sessões',
        enableSubtitleOff: 'Oculta nas sessões',
        autoSpeakTitle: 'Leitura automática',
        autoSpeakFooter: 'O modo mãos-livres continua a ler com a app em segundo plano ou o ecrã bloqueado, e lê todas as respostas sem pausas entre elas.',
        autoSpeakOffLabel: 'Desativado',
        autoSpeakOffSubtitle: 'Ler apenas ao tocar em reproduzir',
        autoSpeakForegroundLabel: 'Com a app aberta',
        autoSpeakForegroundSubtitle: 'Lê em voz alta as novas mensagens do agente enquanto a app está aberta, com 30 segundos de pausa entre respostas',
        autoSpeakHandsFreeLabel: 'Mãos-livres',
        autoSpeakHandsFreeSubtitle: 'Continua a ler com o ecrã desligado ou a app em segundo plano, sem pausas entre respostas',
        providerTitle: 'Fornecedor de voz',
        providerFooter: 'Que serviço converte o resumo em voz. Cada fornecedor guarda a sua própria voz e a sua própria chave, por isso alternar entre eles preserva ambas.',
        providerElevenLabsLabel: 'ElevenLabs',
        providerElevenLabsSubtitle: 'As vozes mais naturais. Requer uma conta ElevenLabs separada.',
        providerOpenAiLabel: 'OpenAI',
        providerOpenAiSubtitle: 'Reutiliza a sua chave da OpenAI, incluindo a do resumo',
        openAiTitle: 'Voz da OpenAI',
        openAiFooter: 'Usado quando a OpenAI é o fornecedor de voz selecionado. Quando não definida, a chave recorre à chave de resumo abaixo.',
        openAiVoiceLabel: 'Voz',
        openAiVoiceSubtitleNotSet: 'Voz padrão (Alloy)',
        openAiVoicePrompt: 'Insira um nome de voz da OpenAI: alloy, echo, fable, onyx, nova ou shimmer. Deixe em branco para a padrão.',
        openAiVoicePlaceholder: 'alloy',
        openAiKeyLabel: 'API Key',
        openAiKeySubtitleNotSet: 'Usa a chave de resumo quando não definida',
        openAiKeySubtitleSet: 'Configurada (oculta)',
        openAiKeyPrompt: 'Insira sua API key da OpenAI. Deixe em branco para reutilizar a chave de resumo.',
        openAiKeyPlaceholder: 'sk-…',
        elevenLabsTitle: 'ElevenLabs',
        elevenLabsFooter: 'Síntese de voz. A chave específica do TTS, quando definida, tem prioridade sobre a chave de voz BYO.',
        voiceIdLabel: 'ID de voz',
        voiceIdSubtitleNotSet: 'Voz padrão (Rachel)',
        voiceIdPrompt: 'Insira o ID de voz do ElevenLabs. Deixe em branco para usar a padrão.',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: 'Usa a chave de voz BYO quando não definida',
        elevenLabsKeySubtitleSet: 'Configurada (oculta)',
        elevenLabsKeyPrompt: 'Insira sua API key do ElevenLabs. Deixe em branco para recorrer à chave de voz BYO.',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: 'Resumo (compatível com OpenAI)',
        llmFooter: 'Qualquer endpoint compatível com OpenAI: OpenAI, OpenRouter, Ollama, vLLM, etc. Para Ollama local, use um hostname do Tailscale ou da LAN (ex.: http://ollama.local:11434/v1) — localhost não funcionará a partir de um telefone.',
        llmBaseUrlLabel: 'URL base',
        llmBaseUrlSubtitleNotSet: 'Não configurado',
        llmBaseUrlPrompt: 'Insira a URL base compatível com OpenAI.',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: 'Não configurada (deixe em branco para Ollama local)',
        llmKeySubtitleSet: 'Configurada (oculta)',
        llmKeyPrompt: 'Insira a API key do LLM. Pode ficar em branco para Ollama local.',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: 'Modelo',
        llmModelSubtitleNotSet: 'Não configurado',
        llmModelPrompt: 'Insira o nome do modelo.',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: 'Privacidade',
        privacyText: 'As API keys são armazenadas localmente neste dispositivo. O texto das mensagens é enviado diretamente para os endpoints do LLM e do ElevenLabs configurados — nunca para os servidores do Happy.',
    },
    ...
    sessionTts: {
        ...
        speak: 'Falar',
        stop: 'Parar',
        continueOption: 'Continuar do último',
        fromLastUser: 'Da sua última mensagem',
        restart: 'Reiniciar do começo',
        loading: 'Resumindo…',
        playing: 'Falando…',
        nothingNew: 'Nada novo para ler',
        configurePrompt: 'Configure o TTS nas Configurações',
    },
    ...
    imageUpload: {
        ...
        cliTooOldTitle: 'Atualize o Happy nessa máquina',
        cliTooOldMessage: ({ requiredVersion }: { requiredVersion: string }) =>
            `A máquina que executa esta sessão precisa do happy CLI ${requiredVersion} ou mais recente para receber imagens. Apenas o texto foi enviado.`,
    },
