...
export const pt: TranslationStructure = {
    ...
    settingsTts: {
        ...
        autoModeLabel: 'Ler automaticamente novas respostas',
        autoModeSubtitle: 'Lê automaticamente em voz alta as novas mensagens do agente enquanto o app está em primeiro plano',
