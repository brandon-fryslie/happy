...
export const es: TranslationStructure = {
    ...
    settingsTts: {
        ...
        autoModeLabel: 'Leer automáticamente las nuevas respuestas',
        autoModeSubtitle: 'Lee automáticamente en voz alta los nuevos mensajes del agente mientras la app está en primer plano',
