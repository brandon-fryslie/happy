...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        tts: 'Sesiones habladas',
        ttsSubtitle: 'Resume y lee en voz alta los mensajes del agente',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Usa tu propio agente de ElevenLabs en lugar del predeterminado de Happy. No se requiere suscripción — conéctate directamente con tu propia cuenta de ElevenLabs. Tu agente debe definir las herramientas de cliente indicadas en la Guía de Prompt del Agente que aparece abajo, y recibe el contexto de la sesión a través de la variable dinámica {{initialConversationContext}}.',
        ...
        promptGuideDescription: ({ toolSignatures }: { toolSignatures: string }) => `Tu agente de ElevenLabs necesita estas herramientas de cliente, con exactamente estos nombres y parámetros:\n\n${toolSignatures}\n\nTambién necesita la variable dinámica {{initialConversationContext}}, que recibe el directorio de sesiones y el historial al iniciar.\n\nHappy identifica cada sesión y cada solicitud de permiso en el contexto que inyecta: los ids de sesión aparecen en el directorio inicial y en cada actualización de foco o estado, y una solicitud de permiso llega envuelta en etiquetas <request_id>. Tu agente devuelve esos ids tal cual — nunca debe inventarse uno.\n\nEl agente actúa como puente de voz entre el usuario y los agentes de código. Debe ser conciso, responder solo cuando se le habla e informar cuando un agente de código termina su trabajo.`,
    ...
    settingsTts: {
        ...
        enabledTitle: 'Sesiones habladas',
        enabledFooter: 'Resume los mensajes del agente con tu propio LLM y léelos en voz alta con ElevenLabs. Todo permanece en tu dispositivo — las claves y el texto de los mensajes nunca llegan a los servidores de Happy.',
        enableLabel: 'Habilitar',
        enableSubtitleOn: 'Barra de control de voz visible en las sesiones',
        enableSubtitleOff: 'Oculta en las sesiones',
        autoSpeakTitle: 'Lectura automática',
        autoSpeakFooter: 'El modo manos libres sigue leyendo con la app en segundo plano o la pantalla bloqueada, y lee cada respuesta sin pausas entre ellas.',
        autoSpeakOffLabel: 'Desactivado',
        autoSpeakOffSubtitle: 'Leer solo al pulsar reproducir',
        autoSpeakForegroundLabel: 'Con la app abierta',
        autoSpeakForegroundSubtitle: 'Lee en voz alta los nuevos mensajes del agente mientras la app está abierta, con 30 segundos de pausa entre respuestas',
        autoSpeakHandsFreeLabel: 'Manos libres',
        autoSpeakHandsFreeSubtitle: 'Sigue leyendo con la pantalla apagada o la app en segundo plano, sin pausas entre respuestas',
        providerTitle: 'Proveedor de voz',
        providerFooter: 'Qué servicio convierte el resumen en voz. Cada proveedor guarda su propia voz y su propia clave, así que cambiar de uno a otro conserva ambas.',
        providerElevenLabsLabel: 'ElevenLabs',
        providerElevenLabsSubtitle: 'Las voces más naturales. Requiere una cuenta de ElevenLabs aparte.',
        providerOpenAiLabel: 'OpenAI',
        providerOpenAiSubtitle: 'Reutiliza tu clave de OpenAI, incluida la del resumen',
        openAiTitle: 'Voz de OpenAI',
        openAiFooter: 'Se usa cuando OpenAI es el proveedor de voz seleccionado. Si no se configura, la clave recurre a la clave de resumen de abajo.',
        openAiVoiceLabel: 'Voz',
        openAiVoiceSubtitleNotSet: 'Voz predeterminada (Alloy)',
        openAiVoicePrompt: 'Ingresa un nombre de voz de OpenAI: alloy, echo, fable, onyx, nova o shimmer. Déjalo vacío para la predeterminada.',
        openAiVoicePlaceholder: 'alloy',
        openAiKeyLabel: 'API Key',
        openAiKeySubtitleNotSet: 'Usa la clave de resumen si no se configura',
        openAiKeySubtitleSet: 'Configurada (oculta)',
        openAiKeyPrompt: 'Ingresa tu API key de OpenAI. Déjala vacía para reutilizar la clave de resumen.',
        openAiKeyPlaceholder: 'sk-…',
        elevenLabsTitle: 'ElevenLabs',
        elevenLabsFooter: 'Síntesis de voz. La clave específica de TTS tiene prioridad sobre la clave de voz BYO cuando está configurada.',
        voiceIdLabel: 'ID de voz',
        voiceIdSubtitleNotSet: 'Voz predeterminada (Rachel)',
        voiceIdPrompt: 'Ingresa el ID de voz de ElevenLabs. Déjalo vacío para usar la predeterminada.',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: 'Usa la clave de voz BYO si no se configura',
        elevenLabsKeySubtitleSet: 'Configurada (oculta)',
        elevenLabsKeyPrompt: 'Ingresa tu API key de ElevenLabs. Déjala vacía para recurrir a la clave de voz BYO.',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: 'Resumen (compatible con OpenAI)',
        llmFooter: 'Cualquier endpoint compatible con OpenAI: OpenAI, OpenRouter, Ollama, vLLM, etc. Para Ollama local usa un nombre de host de Tailscale o LAN (p. ej. http://ollama.local:11434/v1) — localhost no funcionará desde un teléfono.',
        llmBaseUrlLabel: 'URL base',
        llmBaseUrlSubtitleNotSet: 'Sin configurar',
        llmBaseUrlPrompt: 'Ingresa la URL base compatible con OpenAI.',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: 'Sin configurar (déjala vacía para Ollama local)',
        llmKeySubtitleSet: 'Configurada (oculta)',
        llmKeyPrompt: 'Ingresa la API key del LLM. Puede estar vacía para Ollama local.',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: 'Modelo',
        llmModelSubtitleNotSet: 'Sin configurar',
        llmModelPrompt: 'Ingresa el nombre del modelo.',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: 'Privacidad',
        privacyText: 'Las API keys se almacenan localmente en este dispositivo. El texto de los mensajes se envía directamente a los endpoints de tu LLM y ElevenLabs configurados — nunca a los servidores de Happy.',
    },
    ...
    sessionTts: {
        ...
        speak: 'Hablar',
        stop: 'Detener',
        continueOption: 'Continuar desde el último',
        fromLastUser: 'Desde tu último mensaje',
        restart: 'Reiniciar desde el principio',
        loading: 'Resumiendo…',
        playing: 'Hablando…',
        nothingNew: 'Nada nuevo que leer',
        configurePrompt: 'Configura TTS en Ajustes',
    },
    ...
    imageUpload: {
        ...
        cliTooOldTitle: 'Actualiza Happy en esa máquina',
        cliTooOldMessage: ({ requiredVersion }: { requiredVersion: string }) =>
            `La máquina que ejecuta esta sesión necesita happy CLI ${requiredVersion} o posterior para recibir imágenes. Solo se envió el texto.`,
    },
