...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        tts: 'Sessions parlades',
        ttsSubtitle: 'Resumeix i llegeix en veu alta els missatges de l\'agent',
    ...
    settingsTts: {
        ...
        enabledTitle: 'Sessions parlades',
        enabledFooter: 'Resumeix els missatges de l\'agent amb el teu propi LLM i llegeix-los en veu alta amb ElevenLabs. Tot es queda al teu dispositiu — les claus i el text dels missatges no arriben mai als servidors de Happy.',
        enableLabel: 'Activa',
        enableSubtitleOn: 'Barra de control de veu visible a les sessions',
        enableSubtitleOff: 'Amagada a les sessions',
        autoSpeakTitle: 'Lectura automàtica',
        autoSpeakFooter: 'El mode mans lliures continua llegint amb l\'aplicació en segon pla o la pantalla bloquejada, i llegeix cada resposta sense pauses entremig.',
        autoSpeakOffLabel: 'Desactivat',
        autoSpeakOffSubtitle: 'Llegeix només quan premis reprodueix',
        autoSpeakForegroundLabel: 'Amb l\'aplicació oberta',
        autoSpeakForegroundSubtitle: 'Llegeix en veu alta els nous missatges de l\'agent mentre l\'aplicació és oberta, amb 30 segons de pausa entre respostes',
        autoSpeakHandsFreeLabel: 'Mans lliures',
        autoSpeakHandsFreeSubtitle: 'Continua llegint amb la pantalla apagada o l\'aplicació en segon pla, sense pauses entre respostes',
        providerTitle: 'Proveïdor de veu',
        providerFooter: 'Quin servei converteix el resum en veu. Cada proveïdor manté la seva pròpia veu i la seva pròpia clau, així que canviar d\'un a l\'altre les conserva totes dues.',
        providerElevenLabsLabel: 'ElevenLabs',
        providerElevenLabsSubtitle: 'Les veus més naturals. Requereix un compte d\'ElevenLabs a part.',
        providerOpenAiLabel: 'OpenAI',
        providerOpenAiSubtitle: 'Reutilitza la teva clau d\'OpenAI, inclosa la del resum',
        openAiTitle: 'Veu d\'OpenAI',
        openAiFooter: 'S\'utilitza quan OpenAI és el proveïdor de veu seleccionat. Si no està configurada, la clau recorre a la clau del resum de sota.',
        openAiVoiceLabel: 'Veu',
        openAiVoiceSubtitleNotSet: 'Veu predeterminada (Alloy)',
        openAiVoicePrompt: 'Introdueix un nom de veu d\'OpenAI: alloy, echo, fable, onyx, nova o shimmer. Deixa-ho en blanc per a la predeterminada.',
        openAiVoicePlaceholder: 'alloy',
        openAiKeyLabel: 'API Key',
        openAiKeySubtitleNotSet: 'Recorre a la clau del resum si no està configurada',
        openAiKeySubtitleSet: 'Configurada (amagada)',
        openAiKeyPrompt: 'Introdueix la teva API key d\'OpenAI. Deixa-ho en blanc per reutilitzar la clau del resum.',
        openAiKeyPlaceholder: 'sk-…',
        elevenLabsTitle: 'ElevenLabs',
        elevenLabsFooter: 'Síntesi de veu. La clau específica de TTS té prioritat sobre la clau de veu BYO quan està configurada.',
        voiceIdLabel: 'ID de veu',
        voiceIdSubtitleNotSet: 'Veu predeterminada (Rachel)',
        voiceIdPrompt: 'Introdueix l\'ID de veu d\'ElevenLabs. Deixa-ho en blanc per usar la predeterminada.',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: 'Recorre a la clau de veu BYO si no està configurada',
        elevenLabsKeySubtitleSet: 'Configurada (amagada)',
        elevenLabsKeyPrompt: 'Introdueix la teva API key d\'ElevenLabs. Deixa-ho en blanc per recórrer a la clau de veu BYO.',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: 'Resum (compatible amb OpenAI)',
        llmFooter: 'Qualsevol endpoint compatible amb OpenAI: OpenAI, OpenRouter, Ollama, vLLM, etc. Per a Ollama local fes servir un nom d\'amfitrió de Tailscale o LAN (p. ex. http://ollama.local:11434/v1) — localhost no funcionarà des d\'un telèfon.',
        llmBaseUrlLabel: 'URL base',
        llmBaseUrlSubtitleNotSet: 'No configurat',
        llmBaseUrlPrompt: 'Introdueix la URL base compatible amb OpenAI.',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: 'No configurada (deixa-ho en blanc per a Ollama local)',
        llmKeySubtitleSet: 'Configurada (amagada)',
        llmKeyPrompt: 'Introdueix l\'API key del LLM. Pot estar buida per a Ollama local.',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: 'Model',
        llmModelSubtitleNotSet: 'No configurat',
        llmModelPrompt: 'Introdueix el nom del model.',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: 'Privadesa',
        privacyText: 'Les API keys es desen localment en aquest dispositiu. El text dels missatges s\'envia directament als endpoints del LLM i d\'ElevenLabs configurats — mai als servidors de Happy.',
    },
    ...
    sessionTts: {
        ...
        speak: 'Parla',
        stop: 'Atura',
        continueOption: 'Continua des de l\'últim',
        fromLastUser: 'Des del teu últim missatge',
        restart: 'Reinicia des del principi',
        loading: 'Resumint…',
        playing: 'Parlant…',
        nothingNew: 'Res de nou per llegir',
        configurePrompt: 'Configura TTS a Configuració',
    },
