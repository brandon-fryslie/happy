...
export const ca: TranslationStructure = {
    ...
    settingsTts: {
        ...
        autoModeLabel: 'Llegeix automàticament les noves respostes',
        autoModeSubtitle: 'Llegeix automàticament en veu alta els nous missatges de l\'agent mentre l\'aplicació està en primer pla',
