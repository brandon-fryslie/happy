...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        tts: 'Mówione sesje',
        ttsSubtitle: 'Podsumowuj i czytaj wiadomości agenta na głos',
    ...
    newSession: {
        ...
        addProjectDirectory: 'Dodaj jako katalog projektów',
        removeProjectDirectory: 'Usuń katalog projektów',
        noProjectDirectories: 'Dodaj katalog główny za pomocą +',
        emptyProjectDirectory: 'Nie znaleziono podkatalogów',
    },
    ...
    settingsTts: {
        ...
        enabledTitle: 'Mówione sesje',
        enabledFooter: 'Podsumowuj wiadomości agenta przy pomocy własnego LLM i czytaj je na głos przez ElevenLabs. Wszystko pozostaje na Twoim urządzeniu — klucze i treść wiadomości nigdy nie trafiają na serwery Happy.',
        enableLabel: 'Włącz',
        enableSubtitleOn: 'Pasek sterowania mową widoczny w sesjach',
        enableSubtitleOff: 'Ukryty w sesjach',
        autoSpeakTitle: 'Automatyczne czytanie',
        autoSpeakFooter: 'Tryb bez użycia rąk czyta dalej, gdy aplikacja działa w tle lub ekran jest zablokowany, i odczytuje każdą odpowiedź bez przerw.',
        autoSpeakOffLabel: 'Wyłączone',
        autoSpeakOffSubtitle: 'Czytaj tylko po naciśnięciu przycisku odtwarzania',
        autoSpeakForegroundLabel: 'Gdy aplikacja jest otwarta',
        autoSpeakForegroundSubtitle: 'Czytaj na głos nowe wiadomości agenta, gdy aplikacja jest otwarta, z 30-sekundową przerwą między odpowiedziami',
        autoSpeakHandsFreeLabel: 'Bez użycia rąk',
        autoSpeakHandsFreeSubtitle: 'Czytaj dalej przy wyłączonym ekranie lub aplikacji w tle, bez przerw między odpowiedziami',
        providerTitle: 'Dostawca głosu',
        providerFooter: 'Usługa, która zamienia podsumowanie w mowę. Każdy dostawca przechowuje własny głos i własny klucz, więc przełączanie między nimi zachowuje oba.',
        providerElevenLabsLabel: 'ElevenLabs',
        providerElevenLabsSubtitle: 'Najbardziej naturalne głosy. Wymaga osobnego konta ElevenLabs.',
        providerOpenAiLabel: 'OpenAI',
        providerOpenAiSubtitle: 'Używa ponownie Twojego klucza OpenAI, w tym tego od podsumowywania',
        openAiTitle: 'Mowa OpenAI',
        openAiFooter: 'Używane, gdy wybranym dostawcą głosu jest OpenAI. Jeśli klucz nie jest ustawiony, używany jest klucz podsumowywania poniżej.',
        openAiVoiceLabel: 'Głos',
        openAiVoiceSubtitleNotSet: 'Głos domyślny (Alloy)',
        openAiVoicePrompt: 'Wprowadź nazwę głosu OpenAI: alloy, echo, fable, onyx, nova lub shimmer. Pozostaw puste, aby użyć domyślnego.',
        openAiVoicePlaceholder: 'alloy',
        openAiKeyLabel: 'API Key',
        openAiKeySubtitleNotSet: 'Jeśli nie ustawiony, używany jest klucz podsumowywania',
        openAiKeySubtitleSet: 'Skonfigurowany (ukryty)',
        openAiKeyPrompt: 'Wprowadź swój API key OpenAI. Pozostaw puste, aby ponownie użyć klucza podsumowywania.',
        openAiKeyPlaceholder: 'sk-…',
        elevenLabsTitle: 'ElevenLabs',
        elevenLabsFooter: 'Synteza mowy. Klucz dedykowany dla TTS, jeśli ustawiony, ma pierwszeństwo przed kluczem głosu BYO.',
        voiceIdLabel: 'ID głosu',
        voiceIdSubtitleNotSet: 'Głos domyślny (Rachel)',
        voiceIdPrompt: 'Wprowadź ID głosu ElevenLabs. Pozostaw puste, aby użyć domyślnego.',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: 'Jeśli nie ustawiony, używany jest klucz głosu BYO',
        elevenLabsKeySubtitleSet: 'Skonfigurowany (ukryty)',
        elevenLabsKeyPrompt: 'Wprowadź swój API key ElevenLabs. Pozostaw puste, aby użyć klucza głosu BYO.',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: 'Podsumowywanie (kompatybilne z OpenAI)',
        llmFooter: 'Dowolny endpoint kompatybilny z OpenAI: OpenAI, OpenRouter, Ollama, vLLM itp. Dla lokalnego Ollama użyj nazwy hosta Tailscale lub LAN (np. http://ollama.local:11434/v1) — localhost nie zadziała z telefonu.',
        llmBaseUrlLabel: 'Bazowy URL',
        llmBaseUrlSubtitleNotSet: 'Nie skonfigurowano',
        llmBaseUrlPrompt: 'Wprowadź bazowy URL kompatybilny z OpenAI.',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: 'Nie skonfigurowano (pozostaw puste dla lokalnego Ollama)',
        llmKeySubtitleSet: 'Skonfigurowany (ukryty)',
        llmKeyPrompt: 'Wprowadź API key dla LLM. Może być pusty dla lokalnego Ollama.',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: 'Model',
        llmModelSubtitleNotSet: 'Nie skonfigurowano',
        llmModelPrompt: 'Wprowadź nazwę modelu.',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: 'Prywatność',
        privacyText: 'API keys są przechowywane lokalnie na tym urządzeniu. Treść wiadomości jest wysyłana bezpośrednio do skonfigurowanych przez Ciebie endpointów LLM i ElevenLabs — nigdy na serwery Happy.',
    },
    ...
    sessionTts: {
        ...
        speak: 'Mów',
        stop: 'Zatrzymaj',
        continueOption: 'Kontynuuj od ostatniego',
        fromLastUser: 'Od Twojej ostatniej wiadomości',
        restart: 'Uruchom od początku',
        loading: 'Podsumowywanie…',
        playing: 'Mówienie…',
        nothingNew: 'Nic nowego do przeczytania',
        configurePrompt: 'Skonfiguruj TTS w Ustawieniach',
    },
