...
export const pl: TranslationStructure = {
    ...
    settingsTts: {
        ...
        autoModeLabel: 'Automatycznie czytaj nowe odpowiedzi',
        autoModeSubtitle: 'Automatycznie czytaj na głos nowe wiadomości agenta, gdy aplikacja działa na pierwszym planie',
