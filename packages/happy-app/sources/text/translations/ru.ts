...
export const ru: TranslationStructure = {
    ...
    settingsTts: {
        ...
        autoModeLabel: 'Автоматически озвучивать новые ответы',
        autoModeSubtitle: 'Автоматически зачитывать новые сообщения агента вслух, пока приложение на переднем плане',
