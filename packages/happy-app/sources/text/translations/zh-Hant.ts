...
export const zhHant: TranslationStructure = {
    ...
    settingsTts: {
        ...
        enabledTitle: '朗讀工作階段',
        enabledFooter: '使用您自己的 LLM 摘要代理訊息,並透過 ElevenLabs 朗讀出來。一切都保留在您的裝置上 — 金鑰和訊息文字絕不會傳送至 Happy 伺服器。',
        enableLabel: '啟用',
        enableSubtitleOn: '工作階段中顯示朗讀控制列',
        enableSubtitleOff: '在工作階段中隱藏',
        autoSpeakTitle: '自動朗讀',
        autoSpeakFooter: '免持模式在應用程式位於背景或螢幕鎖定時繼續朗讀，並逐則朗讀每個回應，中間不停頓。',
        autoSpeakOffLabel: '關閉',
        autoSpeakOffSubtitle: '僅在點擊播放時朗讀',
        autoSpeakForegroundLabel: '應用程式開啟時',
        autoSpeakForegroundSubtitle: '應用程式開啟時朗讀代理的新訊息，回應之間間隔 30 秒',
        autoSpeakHandsFreeLabel: '免持',
        autoSpeakHandsFreeSubtitle: '在螢幕關閉或應用程式位於背景時繼續朗讀，回應之間沒有間隔',
        ...
        elevenLabsFooter: '語音合成。當設定 TTS 專用金鑰時,其優先順序高於 BYO 語音金鑰。',
        voiceIdLabel: '語音 ID',
        voiceIdSubtitleNotSet: '預設語音 (Rachel)',
        voiceIdPrompt: '輸入 ElevenLabs 語音 ID。留空使用預設值。',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: '未設定時退回使用 BYO 語音金鑰',
        elevenLabsKeySubtitleSet: '已設定 (已隱藏)',
        elevenLabsKeyPrompt: '輸入您的 ElevenLabs API key。留空則退回使用 BYO 語音金鑰。',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: '摘要 (相容 OpenAI)',
        llmFooter: '任何相容 OpenAI 的端點:OpenAI、OpenRouter、Ollama、vLLM 等。對於本機 Ollama,請使用 Tailscale 或 LAN 主機名稱 (例如 http://ollama.local:11434/v1) — localhost 在手機上無法使用。',
        llmBaseUrlLabel: 'Base URL',
        llmBaseUrlSubtitleNotSet: '未設定',
        llmBaseUrlPrompt: '輸入相容 OpenAI 的 base URL。',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: '未設定 (本機 Ollama 可留空)',
        llmKeySubtitleSet: '已設定 (已隱藏)',
        llmKeyPrompt: '輸入 LLM 的 API key。本機 Ollama 可以留空。',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: '模型',
        llmModelSubtitleNotSet: '未設定',
        llmModelPrompt: '輸入模型名稱。',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: '隱私',
        privacyText: 'API keys 儲存在本裝置上。訊息文字會直接傳送至您所設定的 LLM 與 ElevenLabs 端點 — 絕不會傳送至 Happy 伺服器。',
    },
    ...
    sessionTts: {
        ...
        speak: '朗讀',
        stop: '停止',
        continueOption: '從上次繼續',
        fromLastUser: '從您最後的訊息開始',
        restart: '從頭開始',
        loading: '摘要中…',
        playing: '朗讀中…',
        nothingNew: '沒有新內容可讀',
        configurePrompt: '在設定中設定 TTS',
    },
