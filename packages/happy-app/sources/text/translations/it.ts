...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        tts: 'Sessioni parlate',
        ttsSubtitle: 'Riassumi e leggi ad alta voce i messaggi dell\'agente',
    ...
    newSession: {
        ...
        addProjectDirectory: 'Aggiungi come directory dei progetti',
        removeProjectDirectory: 'Rimuovi directory dei progetti',
        noProjectDirectories: 'Aggiungi una directory radice con +',
        emptyProjectDirectory: 'Nessuna sottodirectory trovata',
    },
    ...
    settingsVoice: {
        ...
        byoDescription: 'Usa il tuo agente ElevenLabs al posto di quello predefinito di Happy. Nessun abbonamento richiesto — connettiti direttamente con il tuo account ElevenLabs. Il tuo agente deve definire gli strumenti client elencati nella Guida al Prompt dell\'Agente qui sotto, e riceve il contesto della sessione tramite la variabile dinamica {{initialConversationContext}}.',
        ...
        promptGuideDescription: ({ toolSignatures }: { toolSignatures: string }) => `Il tuo agente ElevenLabs necessita di questi strumenti client, con esattamente questi nomi e parametri:\n\n${toolSignatures}\n\nNecessita anche della variabile dinamica {{initialConversationContext}}, che all'avvio riceve l'elenco delle sessioni e la cronologia.\n\nHappy identifica ogni sessione e ogni richiesta di permesso nel contesto che inietta: gli id di sessione compaiono nell'elenco iniziale e in ogni aggiornamento di focus o di stato, e una richiesta di permesso arriva racchiusa in tag <request_id>. Il tuo agente restituisce quegli id così come sono — non deve mai inventarne uno.\n\nL'agente funge da ponte vocale tra l'utente e gli agenti di codice. Deve essere conciso, rispondere solo quando interpellato e segnalare quando un agente di codice termina il lavoro.`,
    ...
    settingsTts: {
        ...
        enabledTitle: 'Sessioni parlate',
        enabledFooter: 'Riassumi i messaggi dell\'agente con il tuo LLM e leggili ad alta voce con ElevenLabs. Tutto resta sul tuo dispositivo — chiavi e testo dei messaggi non raggiungono mai i server di Happy.',
        enableLabel: 'Abilita',
        enableSubtitleOn: 'Barra di controllo voce mostrata nelle sessioni',
        enableSubtitleOff: 'Nascosta nelle sessioni',
        autoSpeakTitle: 'Lettura automatica',
        autoSpeakFooter: 'La modalità a mani libere continua a leggere con l\'app in background o lo schermo bloccato, e legge ogni risposta senza pause.',
        autoSpeakOffLabel: 'Disattivato',
        autoSpeakOffSubtitle: 'Leggi solo quando premi riproduci',
        autoSpeakForegroundLabel: 'Con l\'app aperta',
        autoSpeakForegroundSubtitle: 'Leggi ad alta voce i nuovi messaggi dell\'agente mentre l\'app è aperta, con 30 secondi di pausa tra le risposte',
        autoSpeakHandsFreeLabel: 'Mani libere',
        autoSpeakHandsFreeSubtitle: 'Continua a leggere con lo schermo spento o l\'app in background, senza pause tra le risposte',
        providerTitle: 'Provider vocale',
        providerFooter: 'Quale servizio trasforma il riassunto in voce. Ogni provider conserva la propria voce e la propria chiave, quindi passare dall\'uno all\'altro le mantiene entrambe.',
        providerElevenLabsLabel: 'ElevenLabs',
        providerElevenLabsSubtitle: 'Le voci più naturali. Richiede un account ElevenLabs separato.',
        providerOpenAiLabel: 'OpenAI',
        providerOpenAiSubtitle: 'Riutilizza la tua chiave OpenAI, inclusa quella del riassunto',
        openAiTitle: 'Voce OpenAI',
        openAiFooter: 'Usato quando OpenAI è il provider vocale selezionato. Se non impostata, la chiave ricade su quella del riassunto qui sotto.',
        openAiVoiceLabel: 'Voce',
        openAiVoiceSubtitleNotSet: 'Voce predefinita (Alloy)',
        openAiVoicePrompt: 'Inserisci un nome di voce OpenAI: alloy, echo, fable, onyx, nova o shimmer. Lascia vuoto per quella predefinita.',
        openAiVoicePlaceholder: 'alloy',
        openAiKeyLabel: 'API Key',
        openAiKeySubtitleNotSet: 'Se non impostata, usa la chiave del riassunto',
        openAiKeySubtitleSet: 'Configurata (nascosta)',
        openAiKeyPrompt: 'Inserisci la tua API key di OpenAI. Lascia vuoto per riutilizzare la chiave del riassunto.',
        openAiKeyPlaceholder: 'sk-…',
        elevenLabsTitle: 'ElevenLabs',
        elevenLabsFooter: 'Sintesi vocale. La chiave specifica per TTS, se impostata, ha la precedenza sulla chiave vocale BYO.',
        voiceIdLabel: 'ID voce',
        voiceIdSubtitleNotSet: 'Voce predefinita (Rachel)',
        voiceIdPrompt: 'Inserisci l\'ID voce di ElevenLabs. Lascia vuoto per usare quella predefinita.',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: 'Se non impostata, usa la chiave vocale BYO',
        elevenLabsKeySubtitleSet: 'Configurata (nascosta)',
        elevenLabsKeyPrompt: 'Inserisci la tua API key di ElevenLabs. Lascia vuoto per usare la chiave vocale BYO.',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: 'Riassunto (compatibile con OpenAI)',
        llmFooter: 'Qualsiasi endpoint compatibile con OpenAI: OpenAI, OpenRouter, Ollama, vLLM, ecc. Per Ollama locale usa un hostname Tailscale o LAN (es. http://ollama.local:11434/v1) — localhost non funzionerà da un telefono.',
        llmBaseUrlLabel: 'URL base',
        llmBaseUrlSubtitleNotSet: 'Non configurato',
        llmBaseUrlPrompt: 'Inserisci la URL base compatibile con OpenAI.',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: 'Non configurata (lascia vuoto per Ollama locale)',
        llmKeySubtitleSet: 'Configurata (nascosta)',
        llmKeyPrompt: 'Inserisci l\'API key dell\'LLM. Può essere vuota per Ollama locale.',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: 'Modello',
        llmModelSubtitleNotSet: 'Non configurato',
        llmModelPrompt: 'Inserisci il nome del modello.',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: 'Privacy',
        privacyText: 'Le API keys sono memorizzate localmente su questo dispositivo. Il testo dei messaggi viene inviato direttamente agli endpoint LLM e ElevenLabs configurati — mai ai server di Happy.',
    },
    ...
    sessionTts: {
        ...
        speak: 'Parla',
        stop: 'Stop',
        continueOption: 'Continua dall\'ultimo',
        fromLastUser: 'Dal tuo ultimo messaggio',
        restart: 'Ricomincia da capo',
        loading: 'Riassunto in corso…',
        playing: 'In riproduzione…',
        nothingNew: 'Niente di nuovo da leggere',
        configurePrompt: 'Configura TTS nelle Impostazioni',
    },
