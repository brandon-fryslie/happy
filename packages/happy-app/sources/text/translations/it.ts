...
export const it: TranslationStructure = {
    ...
    settingsTts: {
        ...
        autoModeLabel: 'Leggi automaticamente le nuove risposte',
        autoModeSubtitle: 'Leggi automaticamente ad alta voce i nuovi messaggi dell\'agente mentre l\'app è in primo piano',
