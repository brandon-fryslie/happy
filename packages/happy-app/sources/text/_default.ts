...
export const en = {
    ...
    settings: {
        ...
        tts: 'Speak Sessions',
        ttsSubtitle: 'Summarize and read agent messages aloud',
    ...
    settingsTts: {
        ...
        enabledTitle: 'Speak Sessions',
        enabledFooter: 'Summarize agent messages with your own LLM and read them aloud with ElevenLabs. Everything stays on your device — keys and message text never reach Happy servers.',
        enableLabel: 'Enable',
        enableSubtitleOn: 'Speaker control bar shown in sessions',
        enableSubtitleOff: 'Hidden in sessions',
        autoSpeakTitle: 'Auto-Speak',
        autoSpeakFooter: 'Hands-free keeps speaking with the app in the background or the screen locked, and reads every reply instead of pausing between them.',
        autoSpeakOffLabel: 'Off',
        autoSpeakOffSubtitle: 'Only speak when you tap play',
        autoSpeakForegroundLabel: 'While Watching',
        autoSpeakForegroundSubtitle: 'Read new agent messages aloud while the app is open, pausing 30 seconds between replies',
        autoSpeakHandsFreeLabel: 'Hands-Free',
        autoSpeakHandsFreeSubtitle: 'Keep reading with the screen off or the app in the background, with no pause between replies',
        providerTitle: 'Voice Provider',
        providerFooter: 'Which service turns the summary into speech. Each provider keeps its own voice and key, so switching back and forth preserves both.',
        providerElevenLabsLabel: 'ElevenLabs',
        providerElevenLabsSubtitle: 'Most natural voices. Needs a separate ElevenLabs account.',
        providerOpenAiLabel: 'OpenAI',
        providerOpenAiSubtitle: 'Reuses your OpenAI key, including the summarization one',
        openAiTitle: 'OpenAI Speech',
        openAiFooter: 'Used when OpenAI is the selected voice provider. The key falls back to the summarization key below when not set.',
        openAiVoiceLabel: 'Voice',
        openAiVoiceSubtitleNotSet: 'Default voice (Alloy)',
        openAiVoicePrompt: 'Enter an OpenAI voice name: alloy, echo, fable, onyx, nova, or shimmer. Leave empty for the default.',
        openAiVoicePlaceholder: 'alloy',
        openAiKeyLabel: 'API Key',
        openAiKeySubtitleNotSet: 'Falls back to the summarization key when not set',
        openAiKeySubtitleSet: 'Configured (hidden)',
        openAiKeyPrompt: 'Enter your OpenAI API key. Leave empty to reuse the summarization key.',
        openAiKeyPlaceholder: 'sk-…',
        elevenLabsTitle: 'ElevenLabs',
        elevenLabsFooter: 'Voice synthesis. The TTS-specific key takes precedence over the BYO voice key when set.',
        voiceIdLabel: 'Voice ID',
        voiceIdSubtitleNotSet: 'Default voice (Rachel)',
        voiceIdPrompt: 'Enter the ElevenLabs voice ID. Leave empty for the default.',
        voiceIdPlaceholder: '21m00Tcm4TlvDq8ikWAM',
        elevenLabsKeyLabel: 'API Key',
        elevenLabsKeySubtitleNotSet: 'Falls back to BYO voice key when not set',
        elevenLabsKeySubtitleSet: 'Configured (hidden)',
        elevenLabsKeyPrompt: 'Enter your ElevenLabs API key. Leave empty to fall back to the BYO voice key.',
        elevenLabsKeyPlaceholder: 'sk_…',
        llmTitle: 'Summarization (OpenAI-compatible)',
        llmFooter: 'Any OpenAI-compatible endpoint: OpenAI, OpenRouter, Ollama, vLLM, etc. For local Ollama use a Tailscale or LAN hostname (e.g. http://ollama.local:11434/v1) — localhost will not work from a phone.',
        llmBaseUrlLabel: 'Base URL',
        llmBaseUrlSubtitleNotSet: 'Not configured',
        llmBaseUrlPrompt: 'Enter the OpenAI-compatible base URL.',
        llmBaseUrlPlaceholder: 'https://api.openai.com/v1',
        llmKeyLabel: 'API Key',
        llmKeySubtitleNotSet: 'Not configured (leave empty for local Ollama)',
        llmKeySubtitleSet: 'Configured (hidden)',
        llmKeyPrompt: 'Enter the LLM API key. May be empty for local Ollama.',
        llmKeyPlaceholder: 'sk-…',
        llmModelLabel: 'Model',
        llmModelSubtitleNotSet: 'Not configured',
        llmModelPrompt: 'Enter the model name.',
        llmModelPlaceholder: 'gpt-4o-mini',
        privacyTitle: 'Privacy',
        privacyText: 'API keys are stored locally on this device. Message text is sent directly to your configured LLM and ElevenLabs endpoints — never to Happy servers.',
    },
    ...
    sessionTts: {
        ...
        speak: 'Speak',
        stop: 'Stop',
        continueOption: 'Continue from last',
        fromLastUser: 'From your last message',
        restart: 'Restart from beginning',
        loading: 'Summarizing…',
        playing: 'Speaking…',
        nothingNew: 'Nothing new to read',
        configurePrompt: 'Configure TTS in Settings',
    },
